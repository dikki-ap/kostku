                      ...
                      <form action="/register" method="POST">
                        ...
                        <div class="form-floating">
                            <input type="text" name="name" class="form-control @error('name')
                                is-invalid
                            @enderror" id="name" placeholder="Name" autofocus required value="{{ old('name') }}">
                        ...
                        <div class="form-floating">
                            <input type="number" name="phone_number" class="form-control @error('phone_number')
                                is-invalid
                            @enderror" id="phone_number" placeholder="phone_number" autofocus required value="{{ old('phone_number') }}">
                        ...
                        <button class="w-100 btn btn-lg btn-primary border-0 mt-3" type="submit" style="background-color: #15adcc"><span data-feather="user-plus"></span>&nbsp; Register</button>
                    </form>
                    <small class="d-block text-center mt-3">Sudah registrasi? <a href="/login" class="text-decoration-none" style="color: #15adcc">Login Sekarang!</a></small>
                    </div>
                </div>
            </div>
        </div>
