                ...
                <div class="card rounded-3 shadow p-3">
                    ...
                    <div class="card-body">
                      ...
                      <form action="/login" method="POST">
                        ...
                        <button class="w-100 btn btn-lg btn-primary border-0 mt-3" type="submit" style="background-color: #15adcc"><span data-feather="log-in"></span>&nbsp; Login</button>
                    </form>
                    <small class="d-block text-center mt-3">Belum registrasi? <a href="/register" class="text-decoration-none" style="color: #15adcc">Registrasi Sekarang!</a></small>
                    </div>
                </div>
            </div>
        </div>
