    ...
    <div class="row" style="color: #15adcc">
        ...
        <form action="/dashboard/categories/{{ $category->id }}" method="POST" class="mb-5">
                ...
                <div class="col-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name')
                            is-invalid
                        @enderror" id="name" autofocus required value="{{ old('name', $category->name) }}">
                        @error('name')
            ...
            <div class="row">
                <div class="col">
                    {{-- Button Create --}}
                    <button type="submit" class="btn btn-primary border-0" style="background-color: #15adcc">Edit Category</button>
                </div>
            </div>
        </form>
